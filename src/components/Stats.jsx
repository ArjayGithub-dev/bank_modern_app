...
const Stats = () => (
  <section className={`${styles.flexCenter} flex-row flex-wrap sm:mb-20 mb-6`}>
    {stats.map((stat) => (
      <div key={stat.id} className={`${styles.flex-1} flex justify-start items-center flex-row m-3 animate-fade-left animate-once animate-ease-in animate-duration-1000`}>
